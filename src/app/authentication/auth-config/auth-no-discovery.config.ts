...
export const noDiscoveryAuthConfig: AuthConfig = {
  ...
  options: undefined, // Changed from null to undefined
  ...
  dummyClientSecret: undefined, // Changed from null to undefined
  ...
  customQueryParams: undefined, // Changed from null to undefined
