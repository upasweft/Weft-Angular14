...
@Component({
  selector: 'app-aminusercreate',
  templateUrl: './aminusercreate.component.html',
  styleUrls: ['./aminusercreate.component.scss']
})
export class AminusercreateComponent implements OnInit {
  ...
  resourceName: string = 'Admin Users';
  resourceManagementNavPath: string = "/admin/adminusers-management";
  ...
  getResourceById() {
    this.httpService.get(this.resourceGetByIdApi + this.resourceKeyValue).subscribe(x => {
      ...
      this.resourceForm = this.fb.group({
        ...
        phone: new FormControl({ value: x["phone"], disabled: false }, Validators.compose([Validators.required,Validators.minLength(10), Validators.maxLength(13), Validators.pattern("^[0-9,+]*$")])),
