...
@Component({
  selector: 'app-dailysalesmangement',
  templateUrl: './dailysalesmangement.component.html',
  styleUrls: ['./dailysalesmangement.component.scss']
})
export class DailysalesmangementComponent implements OnInit {
  public gridManagementForm: FormGroup;
  @ViewChild(DxDataGridComponent, { static: false }) dataGrid: DxDataGridComponent;
  public title: string = 'Daily Sales Report';
  ...
  constructor(public route: ActivatedRoute,
    ...
    this.columnDefs = [
     ...
     // {dataField : 'refNum',caption : 'Ref Number'},
      ...
      { dataField : 'cash', caption : 'Cash',format: { type: 'fixedPoint', precision: 2 }},
      { dataField : 'card', caption : 'Card',format: { type: 'fixedPoint', precision: 2 }},
  ...
  ngOnInit() {
    ...
    console.log(this.resourceKeyValue.dateFrom)
    this.createForm();
